...
namespace WindowsFormsApp2
{
    public partial class SF_CNC : UserControl
    {
       ...
       // private Form1 form1_;
        ...
        public void save_data_NG(string qty,string ket, string jenisNG)
        {
            string query = "insert into TrRPHMesinNG(KodeMesin, tanggal, sift, jam, lotno, itemid, operator, qtylot, KETERANGAN, qty, tipe, skema, partno, sisi) values(@mesin,convert(varchar(10),getdate(),120),@sift, convert(varchar(10),getdate(),108), @lotno, @itemid, @operator, @qtylot, @keterangan, @qtyng, @tipe, @skema, @sisi)";
            SqlCommand cmd = new SqlCommand("insert into TrRPHMesinNG(KodeMesin, tanggal, sift, jam, lotno, itemid, operator, qtylot, KETERANGAN, qty, tipe, skema, partno) values(@mesin,convert(varchar(10),getdate(),120),@sift, convert(varchar(10),getdate(),108), @lotno, @itemid, @operator, @qtylot, @keterangan, @qtyng, @tipe, @skema)", cnn);
            cmd.Parameters.AddWithValue("@mesin", login.machine);
            cmd.Parameters.AddWithValue("@sift", login.shift);
            cmd.Parameters.AddWithValue("@lotno", label46.Text);
            cmd.Parameters.AddWithValue("@itemid", "itemid");
            cmd.Parameters.AddWithValue("@operator", login.NoReg);
            cmd.Parameters.AddWithValue("@qtylot", label43.Text);
            cmd.Parameters.AddWithValue("@keterangan", "keterangan");
            cmd.Parameters.AddWithValue("@qtyng", qty);
            cmd.Parameters.AddWithValue("@keterangan", ket);
            cmd.Parameters.AddWithValue("@tipe", jenisNG);
            cmd.Parameters.AddWithValue("@skema", label44.Text);
        ...
        private void rjButton6_Click(object sender, EventArgs e)
        {
            ...
            */
            NG_RECORD ng_record = new NG_RECORD(this);
            ng_record.Show();
            ng_record.label5.Text = label45.Text;
            ng_record.label6.Text = label46.Text;
            ng_record.label7.Text = label44.Text;
